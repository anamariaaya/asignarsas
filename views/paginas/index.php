    ...
    <div class="enlaces-main">
        ...
        <div class="blend-main">
            <picture>
                ...
                <img src="/build/img/ofertas.png" alt="Ofertas Laborales">
            </picture>   
        </div>     
    </div>
    ...
    <div class="enlaces-main">
        ...
        <div class="blend-main">
            <picture>
                ...
                <img src="/build/img/empleados.png" alt="Empleados">
            </picture>   
        </div>     
    </div>
</main>
...
<section class="contenedor valor">
    ...
    <div class="valores-section">
        <div class="valores">
            <img class="icono" src="/build/img/oportunidad.svg" alt="Oportunidad"/>
            <p>Oportunidad</p>
        </div>
        <div class="valores">
            <img class="icono" src="/build/img/disposicion.svg" alt="Disposición de servicio"/>
            <p>Disposición de servicio</p>
        </div>
        <div class="valores">
            <img class="icono" src="/build/img/acompañamiento.svg" alt="Acompañamiento continuo"/>
            <p>Acompañamiento continuo</p>
        </div>
        <div class="valores">
            <img class="icono" src="/build/img/calidad.svg" alt="Calidad"/>
            <p>Calidad</p>
        </div>
    </div>
</section>
...
<section class="contenedor valor-corporativo">
    ...
    <div class="corporativos-section">
        <div class="corporativos">
            <img class="icono" src="/build/img/servicio.svg" alt="Servicio"/>
            <p>Servicio</p>
        </div>
        <div class="corporativos">
            <img class="icono" src="/build/img/responsabilidad.svg" alt="Responsabilidad"/>
            <p>Responsabilidad</p>
        </div>
        <div class="corporativos">
            <img class="icono" src="/build/img/respeto.svg" alt="Respeto"/>
            <p>Respeto</p>
        </div>
        <div class="corporativos">
            <img class="icono" src="/build/img/honestidad.svg" alt="Honestidad"/>
            <p>Honestidad</p>
        </div>
        <div class="corporativos">
            <img class="icono" src="/build/img/liderazgo.svg" alt="Liderazgo"/>
            <p>Liderazgo</p>
        </div>
    </div>
...
<section>
    <div class="segmentos">
        <div class="areas">
            ...
            <img src="/build/img/misionales.webp" alt="Empleados Misionales"/>
        ...
        <div class="areas">
            ...
            <img src="/build/img/responsabilidadsocial.webp" alt="Responsabilidad Social Empresarial"/>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus modi enim velit sed expedita ad qui repudiandae voluptate fuga ea. Unde, repellendus quaerat consequatur hic facilis praesentium recusandae temporibus ea! </p>
        </div>
        <div class="areas">
            <h2>Empleados Administrativos</h2>
            <img src="/build/img/administrativos.webp" alt="Empleados Administrativos"/>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus modi enim velit sed expedita ad qui repudiandae voluptate fuga ea. Unde, repellendus quaerat consequatur hic facilis praesentium recusandae temporibus ea!</p>
        </div>
    </div>
</section>
...
<section>
    <div class="carrusel">
        ...
        <div class="slide fade">
            ...
            <img class="hotel" src="/build/img/diez.webp" alt="Logo Hotel Diez">
            <img class="hotel" src="/build/img/country.webp" alt="Logo Country Club">
            <img class="hotel" src="/build/img/dann.webp" alt="Logo Hoteles Dann">
            <img class="hotel" src="/build/img/atton.webp" alt="Logo Hoteles Atton">
            <img class="hotel" src="/build/img/nh.webp" alt="Logo Hoteles Nh">
            <img class="hotel" src="/build/img/union.webp" alt="Logo Club Unión Medellín">
        ...
        <div class="slide fade">
            ...
            <img class="otros" src="/build/img/medicox.webp" alt="Logo Medicox">
            <img class="otros" src="/build/img/hrmd.webp" alt="Logo HRMD">
            <img class="otros" src="/build/img/frutafresca.webp" alt="Logo Fruta Fresca">
