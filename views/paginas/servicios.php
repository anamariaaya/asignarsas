<main class="contenedor">
    <div class="grid-servicios">
        <a href="#seleccion">
            <div class="servicio">
                <img src="/build/img/seleccion.svg" alt="Selección" loading="lazy">
                <p>Selección</p>
            </div>
        </a>
        <a href="#contratacion">
        ...
        <a href="#sst">
            <div class="servicio">
                <img src="/build/img/sst.svg" alt="Seguridad y salud en el trabajo" loading="lazy">
                <p>SG-SST</p>
            </div>
        </a>
        <a href="#nomina">
            <div class="servicio">
                <img src="/build/img/nomina.svg" alt="Nómina" loading="lazy">
                <p>Nómina</p>
            </div>
        </a>
        <a href="#personal" class="divtablet">
            <div class="servicio">
                <img src="/build/img/personal.svg" alt="Administración de personal" loading="lazy">
...
<section class="contenedor tipo-servicio" id="sst">
    <div class="imagen-servicio left">
        <img src="/build/img/sstfondo.png" alt="Seguridad y Salud en el trabajo" loading="lazy">
    </div>
    <div class="info-servicio right">
        <h1>SG-SST</h1>
...
<section class="contenedor tipo-servicio" id="nomina">
    ...
    <div class="imagen-servicio right">
        <img src="/build/img/nominafondo.png" alt="Nómina" loading="lazy">
    </div>
</section>

<section class="contenedor tipo-servicio" id="personal">
    <div class="imagen-servicio left">
        <img src="/build/img/personalfondo.png" alt="Administración de personal" loading="lazy">
    </div>
    <div class="info-servicio right">
